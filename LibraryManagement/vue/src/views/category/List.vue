    ...
    <el-table :data="tableData" stripe row-key="id" default-expand-all>
        ...
        <el-table-column label="操作" width="250">
            <template v-slot="scope">
                <el-button style="" v-if="!scope.row.pid"  @click="handleAdd(scope.row)" type="success" size="mini">添加子分类</el-button>
                <el-popconfirm  title="您确定删除这行数据嘛？" @confirm="del(scope.row.id)">
                    <el-button style="margin-left: 10px; float: right; " type="danger" size="mini" slot="reference">删除</el-button>
                </el-popconfirm>
